        ...
        <figcaption className={'about-me__signature'}>
          <blockquote className="about-me__citation">
            ...
            <p className="about-me__quote">
              Я родился и живу в Екатеринбурге, закончил факультет спортивного менеджмента РГППУ. Я
              занимаюсь BJJ и силовым экстримом в Академии единоборств РМК. Начал кодить чуть больше
              года назад. С 2019 года работаю в компании «ТоргМастер» администратором сайтов.
              Активно развиваюсь в направлении веб-разработки, изучаю React, TypeScript. В
              дальнейшем планирую попробовать себя в Mobile App Development.
            </p>
          </blockquote>
