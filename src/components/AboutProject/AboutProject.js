  ...
  return (
    ...
    >
      ...
      <div className={"about-project__diagrams"}>
        <span
          className={
            "about-project__diagram about-project__diagram_weeks-backend"
          }
        >
          1 неделя
        </span>
        <span
          className={
            "about-project__diagram about-project__diagram_weeks-frontend"
          }
        >
          4 недели
        </span>
        <span
          className={"about-project__diagram about-project__diagram_caption"}
        >
          Back-end
        </span>
        <span
